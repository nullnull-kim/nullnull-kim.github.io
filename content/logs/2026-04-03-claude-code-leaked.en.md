---
title: "Claude Code Source Code Got Leaked"
date: 2026-04-03T00:00:00+09:00
categories: [logs]
tags: [claude, claude-code, harness-engineering, source-code, ai-workflow]
slug: claude-code-leaked
description: "The day Claude Code's source code leaked, I pulled two all-nighters after work building an agent harness. Then I opened the source and found everything I'd built was already in there. A tale of wasted effort."
---

Claude Code's source code got leaked. Controversy and debate followed, but overnight someone had already built [Claw Code](https://github.com/ultraworkers/claw-code) and was racking up stars from around the world. This was clearly the time to go all in.
...
I had Claude Code analyze Claw Code while I read through the [source analysis docs](https://wikidocs.net/338204) whenever I could.

After reading the [harness engineering guide](https://wikidocs.net/blog/@jaehong/10418/), an idea hit me. I figured I should build a harness for bringing AI into the finance industry — the field I actually work in — something nobody else had jumped on yet.
